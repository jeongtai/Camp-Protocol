...
const main = async () => {
  ...
  const bank = "0xBbba6DBc7b3C2FCFE5676af9E646A115062f2d03"
  ...
  await SCAMP.setBankAddress("0xBbba6DBc7b3C2FCFE5676af9E646A115062f2d03")
  ...
  // await mock.setBalance(bank, toBn("2e6"))
  console.log((await mock.balanceOf(bank)).toString())
