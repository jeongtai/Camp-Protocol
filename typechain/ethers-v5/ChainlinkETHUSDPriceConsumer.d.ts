...
interface ChainlinkETHUSDPriceConsumerInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainlinkETHUSDPriceConsumer extends BaseContract {
  ...
  interface: ChainlinkETHUSDPriceConsumerInterface;
